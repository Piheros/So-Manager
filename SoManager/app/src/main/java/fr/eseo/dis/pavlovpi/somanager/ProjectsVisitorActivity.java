/**
 * @file ProjectVisitorActivity.java
 * @version 0.2
...
/**
 * @class Projects Visitor Activity
 * @brief Show the projects available for visitor
 */
public class ProjectsVisitorActivity extends AppCompatActivity {
    ...
    private void createUrlToGetAllProjects(){
        this.url = this.url + this.userName + "&seed=1542559542"+ "&token=" + this.token;
